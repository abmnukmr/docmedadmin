...
export class AyurvedaPage {
  ...
  hide(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/hide/ayurveda/" + em, JSON.stringify(this.update), options)
  ...
  show(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/show/ayurveda/" + em, JSON.stringify(this.update), options)
      .map(res => res.json()).subscribe(data => {
      console.log(data)
      this.load(this.Loc.lat,this.Loc.lng);
  ...
  delete(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/delete/ayurveda/" + em, JSON.stringify(this.update), options)
      .map(res => res.json()).subscribe(data => {
      console.log(data)
      this.load(this.Loc.lat,this.Loc.lng);
