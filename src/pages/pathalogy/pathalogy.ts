...
loading:any;
  ...
  hide(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/hide/pathalogy/" + em, JSON.stringify(this.update), options)
  ...
  show(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/show/pathalogy/" + em, JSON.stringify(this.update), options)
      .map(res => res.json()).subscribe(data => {
      console.log(data)
     this.load(this.Loc.lat,this.Loc.lng);
      this.loading.dismiss()
  ...
  delete(em){
    ...
    this.http.post("https://quiet-ridge-46090.herokuapp.com/delete/pathalogy/" + em, JSON.stringify(this.update), options)
      .map(res => res.json()).subscribe(data => {
      console.log(data)
      this.load(this.Loc.lat,this.Loc.lng);
